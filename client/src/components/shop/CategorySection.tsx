        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
          <div className="max-w-2xl">
            ...
            <p className="text-zinc-500 dark:text-zinc-400 font-medium text-lg">
              Explore our curated collections crafted for every style and
              occasion
            </p>
          </div>
          <Link
                    ...
                    <div className="relative aspect-[4/3] overflow-hidden bg-zinc-100 dark:bg-zinc-800">
                      {imageUrl ? (
                        ...
                        <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-zinc-100 to-zinc-200 dark:from-zinc-800 dark:to-zinc-900">
                          <Shirt
                            size={64}
                            className="text-zinc-400 dark:text-zinc-600 group-hover:text-black dark:group-hover:text-white transition-colors duration-500"
                          />
                        </div>
                      )}
