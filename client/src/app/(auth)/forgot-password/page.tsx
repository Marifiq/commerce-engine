        ...
        <form className="mt-8 space-y-6" onSubmit={formik.handleSubmit}>
            ...
            <div>
              ...
              <div className="relative mt-1 rounded-md shadow-sm">
                ...
                <input
                  ...
                  type="email"
                  autoComplete="email"
                  className={`block w-full rounded-md border py-2 pl-10 pr-3 sm:text-sm focus:outline-none focus:ring-1 ${
          ...
          <div>
            <button
              type="submit"
              disabled={loading}
              className={`group relative flex w-full justify-center rounded-md bg-white px-4 py-3 text-sm font-semibold text-black shadow-sm hover:bg-zinc-200 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 cursor-pointer ${
